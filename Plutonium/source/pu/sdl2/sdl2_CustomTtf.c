...
int TTF_SizeUTF8(TTF_Font *ttf_font, const char *text, int *w, int *h)
{
    int status;
    int x, z;
    int minx, maxx;
...
SDL_Surface *TTF_RenderUTF8_Solid(TTF_Font *ttf_font,
                const char *text, SDL_Color fg)
{
    SDL_bool first;
    int xstart;
    ...
    if ( ( TTF_SizeUTF8(ttf_font, text, &width, &height) < 0 ) || !width ) {
...
*/
SDL_Surface *TTF_RenderUTF8_Shaded(TTF_Font *ttf_font,
                const char *text, SDL_Color fg, SDL_Color bg)
{
    SDL_bool first;
    int xstart;
...
SDL_Surface *TTF_RenderUTF8_Blended(TTF_Font *ttf_font,
                const char *text, SDL_Color fg)
{
    SDL_bool first;
    int xstart;
...
SDL_Surface *TTF_RenderUTF8_Blended_Wrapped(TTF_Font *ttf_font,
...
{
    font->cpp_font_ref_ptr = cpp_ptr_ref;
}
